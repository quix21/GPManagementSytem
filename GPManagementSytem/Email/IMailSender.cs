...
namespace GPManagementSytem.Email
{
    public interface IMailSender
    {
        ...
        MailMessage Mail(string to, string from, string fromname, string subject, string body, string[] cc = null, string[] bcc = null, string attachment = null, string attachment2 = null);
        /// <summary>
